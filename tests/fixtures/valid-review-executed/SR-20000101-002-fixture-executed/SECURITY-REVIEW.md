...
# Security review rollup: Synthetic execution-backed review fixture
...
One Informational finding; the approved self-test passed. Synthetic fixture.

## 2. Scope and method

- Target: `component://helium-te-poc`.
- Commit: `2222222222222222222222222222222222222222`.
- Execution: `execution-backed` (APPROVAL-001); see `execution-approvals.md` and the manifest.
...
- FINDING-001 (`Informational`): self-test output is not compared against an expected value.
