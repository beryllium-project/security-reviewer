...
# Security review: Synthetic static-only review fixture
...
| `evidence-ledger.md` | `SR-20000101-001-fixture-review-E####` evidence rows |
...
One Medium finding in a synthetic fixture; see `SECURITY-REVIEW.md`.
